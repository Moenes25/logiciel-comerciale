            ...
            <tbody>
              {facture.lignes.map(ligne => (
                <tr key={ligne.id}>
                  ...
                  <td className="col-pu">{ligne.prix_unitaire.toFixed(2)} DNT</td>
        ...
        <div className="totaux-section">
          <div className="totaux-grid">
            ...
            <div className="totaux-montants">
              <p>{facture.totaux.total_ht.toFixed(2)} DNT</p>
              <p>{facture.totaux.total_tva.toFixed(2)} DNT</p>
              <p className="total-ttc">{facture.totaux.total_ttc.toFixed(2)} DNT</p>
            </div>
          </div>
        </div>
