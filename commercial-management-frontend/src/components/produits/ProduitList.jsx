...
const ruptureDisplay= useCountUp(stats.rupture);
  ...
  const exportProduits = () => {
    const exportData = filteredProduits.map((prod) => ({
      ...
      "Prix Achat (DNT)": (prod.prixAchat ?? 0).toFixed(2),
        ...
        >
          ...
          <div className="mt-3">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-sm">
              <div className="rounded-xl border p-2">
                ...
                <div className="font-semibold">{(produit.prixAchat ?? 0).toFixed(2)} DNT</div>
              </div>
              <div className="rounded-xl border p-2">
                <div className="text-xs text-neutral-500">Prix vente</div>
                <div className="font-semibold">{(produit.prixVente ?? 0).toFixed(2)} DNT</div>
              </div>
              <div className="rounded-xl border p-2">
          ...
          <div className="mt-3 rounded-xl border p-2.5 bg-white/70 backdrop-blur">
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="prod-badge">DNT {valeurStock}</span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-sm">
                      <div className="font-medium">{(produit.prixVente ?? 0).toFixed(2)} DNT</div>
                      <div className="text-xs text-neutral-500">{marge}%</div>
                    </div>
