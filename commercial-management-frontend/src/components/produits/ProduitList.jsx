...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 items-stretch">
  {[
    ...
    { label: "Valeur Stock (€)", value: Number(stats.valeurStock), icon: "💰", bg: "from-violet-500/10 to-violet-500/5", glow: "from-violet-400/40" },
  ].map((s, i) => (
    <div
      key={i}
      className="
        ...
        >
          ...
          <div className="mt-3">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-sm">
              ...
              <div className="rounded-xl border p-2">
                <div className="text-xs text-neutral-500">Prix vente</div>
                <div className="font-semibold">{(produit.prixVente ?? 0).toFixed(2)} €</div>
              </div>
              <div className="rounded-xl border p-2">
                <div className="text-xs text-neutral-500">Marge</div>
                <div className="font-semibold">{marge}%</div>
              </div>
              <div className="rounded-xl border p-2">
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-neutral-700">
                  {stock} unités {st.status === "faible" && `(min: ${stockMin})`}
                </span>
              </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-sm">
                      <div className="font-medium">{(produit.prixVente ?? 0).toFixed(2)} €</div>
                      <div className="text-xs text-neutral-500">{marge}%</div>
                    </div>

                    <div className="text-sm">
                      <span className="px-2 py-1 rounded-full text-[11px] bg-neutral-100 text-neutral-700">
                        {produit.stock?.quantite ?? 0} unités
                      </span>
                    </div>
